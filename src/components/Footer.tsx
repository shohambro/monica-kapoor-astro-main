        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pl-56">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              <li>
                <Link href="/about" className=" hover:text-green-300 hover:underline">
                  About
                </Link>
              </li>
              <li>
                <Link href="/services" className=" hover:text-green-300 hover:underline">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/products" className=" hover:text-green-300 hover:underline">
                  Products
                </Link>
              </li>
              <li>
                <Link href="/contact" className=" hover:text-green-300 hover:underline">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a
              ...
              className="text-[#6a1818] hover:text-green-300 hover:underline"
              aria-label="Facebook"
            >
              Facebook
            </a>
